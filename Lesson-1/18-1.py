...
NameClient = input('Имя: ')
numberZ = int(input('Номер заказа: '))

print(f'Здравствуйте, {NameClient}! Ваш номер заказа: {numberZ}. Приятного дня!')
print("Здравствуйте, {name}! Ваш номер заказа: {id}. Приятного дня!".format(name=NameClient, id=numberZ))